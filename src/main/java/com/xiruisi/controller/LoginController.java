...
public class LoginController {
    ...
    public @ResponseBody Map<String,String> sendSms(@RequestBody String phoneNumber,
        ...
        //发送到登录手机
        ZhenziSmsClient client = new ZhenziSmsClient("https://sms_developer.zhenzikj.com", "105554", "YTllYTllODMtNzdiYS00NGRjLTk4MTAtY2I1NjRkZmY0NjY2");
        String result = client.send(phoneNumber, "验证码: " + captcha + ",你正在登录喜瑞斯账号，验证码在5分钟内有效");
