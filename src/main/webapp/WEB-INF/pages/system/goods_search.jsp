            ...
            <div class="py-container">
                        ...
                        <div class="search">
                            <form action="" class="sui-form form-inline">
                                ...
                                <div class="input-append">
                                    <input type="text" id="autocomplete" type="text" class="input-error input-xxlarge" value="${searchName}" />
                ...
                <div class="yui3-g NavList">
                    ...
                    <div class="yui3-u Center navArea">
                        <ul class="nav">
                            <h3 style="margin-left: 40px"> 搜索结果 </h3>
                        </ul>
                    </div>
        ...
        function currentPage(currentPage){
            ...
            */
            ...
            if(currentPage !== ${page.currentPage}){
                location.href = "${pageContext.request.contextPath}/goods/searchGoods?goods_name=${searchName}&currentPage="+currentPage+""
            }
