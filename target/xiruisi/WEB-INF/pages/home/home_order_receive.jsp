            ...
            <div class="yui3-u-1-6 list">
                <div class="list-items">
                    <dl>
                        ...
                        <dd><a href="${pageContext.request.contextPath}/system/toOrderList?username=${Username}&order_status=2&currentPage=1" class="list-active">待收货</a></dd>
                    </dl>
                    <dl>
                        <dt><i>·</i> 我的中心</dt>
                                        ...
                                        <tr>
                                            <td width="35%">
                                                <div class="typographic"><img width="20%" src="${item.goods.image1}" />
                                                    <a href="#" class="block-text">${item.goods.goods_name}</a>
                                            ...
                                            <td width="10%" class="center">
                                                <c:if test="${item.order_status == 0}">
                                                    <ul class="unstyled">
                                                        <li><a href="#" class="sui-btn btn-info pay">立即支付</a></li>
                                                    </ul>
                                                </c:if>
                                                <c:if test="${item.order_status == 1}" >
                                                    <ul class="unstyled">
                                                ...
                                                <c:if test="${item.order_status == 2}">
                                                    <ul class="unstyled">
                                                        <li><a href="${pageContext.request.contextPath}/pay/confirmOrder?username=${Username}&currentPage=${page.currentPage}&out_trade_no=${item.order_num}" class="sui-btn btn-info receive">确认收货</a></li>
                                                    </ul>
                                                </c:if>
                                                <c:if test="${item.order_status == 3}">
                                                    <ul class="unstyled">
